...
export var c = {
  ...
  bottomNavBtn:function(active){return{flex:1,background:"transparent",border:"none",cursor:"pointer",padding:"10px 4px 12px",display:"flex",flexDirection:"column",alignItems:"center",gap:3,color:active?"#a78bfa":"#6b7280",fontSize:11,fontWeight:500,position:"relative"};},
