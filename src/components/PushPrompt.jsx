...
export function PushPromptModal({ user, onClose, showToast }) {
  ...
  var primaryBtn = {width:"100%",background:"#7c3aed",color:"#fff",border:"none",borderRadius:8,padding:"12px",fontSize:14,fontWeight:600,cursor:busy?"wait":"pointer",marginBottom:8,opacity:busy?0.6:1};
